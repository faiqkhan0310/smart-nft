...
import { logout } from "store/admin-slice";
  ...
  return (
    <>
            ...
            <div className="app-branding">
              <a className="app-logo" href="index.html">
                ...
                {/* <img
                  ...
                  alt="logo"
                /> */}
                <span className="logo-text "> SMART NFT PORTAL</span>
              </a>
            </div>
            ...
            <nav id="app-nav-main" className="app-nav app-nav-main flex-grow-1">
              ...
              >
                <li className="nav-item">
                  <Link href="../../dashboard">
                    <a className={`nav-link ${props.DashboardActive}`}>
                ...
                <li>
                  <Link href="../../notifications">
                    <a className={`nav-link ${props.NotificationsActive}`}>
                      <span className="nav-icon">
                        <svg
                          width="1em"
                          height="1em"
                      ...
                      <span className="nav-link-text disabled">
                        Notifications
                      </span>
                    </a>
                  </Link>
                ...
                {/* <li className="nav-item">
                  <Link href="../../art">
                    <a className="nav-link ">
                      ...
                      <span className="nav-link-text">Arts</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li className="nav-item">
                  <Link href="../../creator">
                    <a className="nav-link ">
                      ...
                      <span className="nav-link-text">Creator Request</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li className="nav-item">
                  <Link href="../../exhibition">
                    <a className="nav-link ">
                      ...
                      <span className="nav-link-text">Exhibitions</span>
                    </a>
                  </Link>
                </li> */}
	  ...
	  <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                ...
                <li className="nav-item">
                  <Link href="../../users">
                    <a className={`nav-link ${props.UsersActive}`}>
                      <span className="nav-icon">
                        <svg
                          width="1em"
                          height="1em"
                ...
                <li className="nav-item">
                  <Link href="/classes">
                    <a className={`nav-link ${props.ClassesActive}`}>
                      <span className="nav-icon">
                        <svg
                          width="1em"
                          height="1em"
                ...
                <li className="nav-item">
                  <Link href="/products">
                    <a className={`nav-link ${props.ProductsActive}`}>
                      <span className="nav-icon">
                        <svg
                          width="1em"
                          height="1em"
                ...
                {/* <li className="nav-item">
                  <Link href="../../landing/edit">
                    <a className="nav-link">
                      ...
                      <span className="nav-link-text">Edit Landing Page</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li className="nav-item">
                  <Link href="../../training/">
                    <a className="nav-link">
                      ...
                      <span className="nav-link-text">Edit Training Page</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li className="nav-item">
                  <Link href="/art/mint">
                    <a className="nav-link">
                      ...
                      <span className="nav-link-text">Create NFTs</span>
                    </a>
                  </Link>
                </li> */}
	  ...
	  <path fillRule="evenodd" d="M6 1H1v3h5V1zM1 0a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1H1zm14 12h-5v3h5v-3zm-5-1a1 1 0 0 0-1 1v3a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-5zM6 8H1v7h5V8zM1 7a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H1zm14-6h-5v7h5V1zm-5-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h5a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1h-5z"/>
		                         ...
		                         <span className="nav-link-text">Approved Addressses</span>
		                         <span className="submenu-arrow">
		                             <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-chevron-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	  <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
	</svg>
