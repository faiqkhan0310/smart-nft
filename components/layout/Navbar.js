            ...
            <div class="app-branding">
              <a class="app-logo" href="index.html">
                ...
                {/* <img
                  ...
                  alt="logo"
                /> */}
                <span class="logo-text "> SMART NFT PORTAL</span>
              </a>
            </div>
                ...
                {/* <li class="nav-item">
                  <Link href="../../creator">
                    <a class="nav-link ">
                      ...
                      <span class="nav-link-text">Creator Request</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li class="nav-item">
                  <Link href="../../landing/edit">
                    <a class="nav-link">
                      ...
                      <span class="nav-link-text">Edit Landing Page</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li class="nav-item">
                  <Link href="../../training/">
                    <a class="nav-link">
                      ...
                      <span class="nav-link-text">Edit Training Page</span>
                    </a>
                  </Link>
                </li> */}
                ...
                {/* <li class="nav-item">
                  <Link href="/art/mint">
                    <a class="nav-link">
                      ...
                      <span class="nav-link-text">Create NFTs</span>
                    </a>
                  </Link>
                </li> */}
