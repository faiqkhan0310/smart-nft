...
export default function Item({ posts, totalRecord }) {
  ...
  const paginate = (e, pageNumber) => {
    ...
    fetch(
      `${process.env.BASE_URl}/api/admin/item?currentPage=${pageNumber}&search=${search}&Auctioned=${Auctioned}`,
      {
        method: "GET",
              ...
              <div className="container-fluid">
                <div className="row g-3 mb-4 align-items-center justify-content-between">
                  <div className="col-auto">
                    <h1 className="app-page-title mb-0">Items</h1>

                    <button>
                      <a href="../../item/new" alt="Add items">
                        add Item{" "}
                      </a>
                    </button>
                  </div>
                      ...
                      <table className="table mb-0 text-left">
                        <thead>
                          <tr>
                            ...
                            <th className="cell">Discription</th>
                            <th className="cell">Category</th>
                            <th className="cell">Price</th>
                            <th className="cell">NFTId</th>
                          ...
                          {postsPaginated &&
                            ...
                            postsPaginated.map((data, i) => (
                              <tr key={i}>
                                <td className="cell">
                                  <a
                                    href={`${process.env.BASE_URl}/item/${data._id}`}
                                    target="_blank"
                                  >
                                    {data.CreatorId}
                                  </a>
                                ...
                                <td className="cell">
                                  <span>{data.NFTId ? data.NFTId : "-"}</span>
                                </td>
                                <td className="cell">
